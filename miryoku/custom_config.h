...
#define MIRYOKU_LAYER_TAP                                               \
  &kp Q,             &kp W,             &kp F,             &toggle_plover_off,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT, \
    &kp A,             &kp R,             &kp S,             &kp T,             &kp G,             &kp M,             &kp N,             &kp E,             &kp I,             &kp O, \
    &kp Z,       &kp X,     &kp C,             &D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         &kp DOT,   &kp SLASH, \
...
#define MIRYOKU_ALTERNATIVES_NAV                                        \
  U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND, \
    &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &CAPSLOCK,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT, \
