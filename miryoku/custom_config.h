...
#define MIRYOKU_LAYER_BASE                             \
  &kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT, \
    ...
    U_NP,              U_NP,              U_NP, U_LT(U_NAV, SPACE),U_LT_TO(U_MOUSE, TAB),U_LT(U_NUM, LSHIFT),  &key_repeat, U_NP,  U_NP,              U_NP
...
#define MIRYOKU_LAYER_MOUSE                                      \
  U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND, \
    &mouse-speed-1,          &mouse-speed-2,          &mouse-speed-3,         &mouse-speed-4,         U_NA,              &to U_TAP,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R, \
