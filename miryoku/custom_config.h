...
#define MIRYOKU_LAYER_MOUSE                                      \
  &sk LGUI,              &sk LALT,          &sk LCTRL,       &sk LSHIFT,     U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND, \
    &mouse_speed_1,          &mouse_speed_2,          &hint_mode,         &hint2_mode,         U_NA,              &to U_TAP,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R, \
...
#define MIRYOKU_ALTERNATIVES_NAV                                        \
  U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND, \
    &kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         U_NA,              &sk CAPSLOCK,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT, \
